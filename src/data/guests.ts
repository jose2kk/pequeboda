// AUTO-GENERATED from guests.txt (do not edit by hand).
// Household groups separated by blank lines; "<name> + 1" marks a plus-one.
// NOTE: this list is compiled into the client bundle for the RSVP search.
...
export const INVITE_GROUPS: InviteGroup[] = [
  {
    ...
    "members": [
      {
        "id": "g1-1",
        "name": "Maria Elizabeth Iannitti",
        "allowPlusOne": false
      },
      {
        "id": "g1-2",
        "name": "Jesus Enrique Tudares",
        "allowPlusOne": false
      }
    ]
  },
  ...
  },
  {
    ...
    "members": [
      {
        "id": "g4-1",
        "name": "Salvatore Iannitti",
        "allowPlusOne": false
      },
      {
        "id": "g4-2",
        "name": "Nancy Aristizabal",
        "allowPlusOne": false
      }
    ]
  },
  {
    ...
    "members": [
      {
        "id": "g5-1",
        "name": "Valeria Urdaneta",
        "allowPlusOne": false
      },
      {
        "id": "g5-2",
        "name": "Jonathan Alatriste",
        "allowPlusOne": false
      }
    ]
  },
